    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 via-amber-50 to-white">
      ...
      <section className="bg-white/70 backdrop-blur py-16">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          Each book is carefully crafted with beautiful illustrations and bilingual text.
          Stories are written for young minds — colorful, engaging, and full of wonder.
        </p>
        <p className="text-gray-500 italic text-sm">
          Mỗi cuốn sách được tạo ra với hình ảnh đẹp và văn bản song ngữ.
          Câu chuyện đầy màu sắc, dành cho trí óc trẻ thơ.
        </p>
      </div>
      </section>
      ...
      <footer className="bg-green-900 text-green-200 py-10 px-6">
        <div className="max-w-6xl mx-auto text-center space-y-2">
          <p className="font-semibold">© 2026 Hung Manh Do</p>
          <p className="text-green-400 text-sm">Made with ❤️</p>
        </div>
      </footer>
    </div>
  );
